...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_nullDataHandler$closure", 2, 0, 23, 15],
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 8, 16, 11, 12],
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 8, 16, 11, 12],
  ...
  _StreamIteratorImpl: {
    ...
    }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 11, 16, 11, 12],
    _onDone$0: [function() {
      if (this._state === 2) {
...
["dart.collection", "dart:collection", , P, {
  ...
  }, "call$1", "_defaultHashCode$closure", 2, 0, 25, 21],
  ...
  _Utf8Encoder: {
    ...
    _fillBuffer$3: function(str, start, end) {
      ...
      if (start !== end && (C.JSString_methods.codeUnitAt$1(str, end - 1) & 64512) === 55296)
        --end;
      for (t1 = this._convert$_buffer, t2 = t1.length, stringIndex = start; stringIndex < end; ++stringIndex) {
...
["dart.core", "dart:core", , P, {
  ...
  Uri: {
    "^": "Object;_core$_host,_core$_port,_path,scheme,_userInfo,_query,_fragment,_pathSegments,_queryParameters",
    get$host: function(_) {
    ...
    static: {Uri__defaultPort: function(scheme) {
        ...
        var t1, pathStart, state, i, t2, $char, index, t3, path, numberSignIndex, query, fragment;
        t1 = {};
  ...
  Uri__makeQuery_closure: {
    "^": "Closure:13;_box_0,_core$_captured_result_1",
    call$2: function(key, value) {
      var t1 = this._box_0;
      if (!t1._captured_first_0)
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 2, 27],
  ...
  }, "call$1", "_convertToDart$closure", 2, 0, 28, 27],
...
["node_io.http", "package:node_io/http.dart", , Z, {
  ...
  HttpException: {
    ...
    static: {HttpException$: function(message, uri) {
        return new Z.HttpException(message, uri);
      }}
  },
  _HttpHeaders: {
    "^": "Object;_headers,protocolVersion,_mutable,_noFoldingHeaders,_contentLength,_persistentConnection,_chunkedTransferEncoding,_host,_port,_defaultPortForScheme",
    ...
    _addAll$2: function($name, value) {
      ...
      if (!!t1.$isIterable)
        for (t1 = t1.get$iterator(value); t1.moveNext$0();)
          this._add$2($name, Z._HttpHeaders__validateValue(t1.get$current()));
      else
        this._add$2($name, Z._HttpHeaders__validateValue(value));
    },
    forEach$1: function(_, f) {
    ...
    set$contentLength: function(contentLength) {
      ...
      t1 = !this._mutable;
      if (t1)
        H.throwExpression(Z.HttpException$("HTTP headers are not mutable", null));
      t2 = this.protocolVersion;
      t3 = J.getInterceptor(t2);
      if (t3.$eq(t2, "1.0") && this._persistentConnection && J.$eq(contentLength, -1))
        throw H.wrapException(Z.HttpException$("Trying to clear ContentLength on HTTP 1.0 headers with 'Connection: Keep-Alive' set", null));
    ...
    set$chunkedTransferEncoding: function(chunkedTransferEncoding) {
      ...
      if (chunkedTransferEncoding && J.$eq(this.protocolVersion, "1.0"))
        throw H.wrapException(Z.HttpException$("Trying to set 'Transfer-Encoding: Chunked' on HTTP 1.0 headers", null));
        ...
        case 4:
          if ("date" === $name) {
            if (value instanceof P.DateTime) {
              ...
              H.throwExpression(Z.HttpException$("Unexpected type for header named " + $name, null));
            return;
          }
          if ("host" === $name) {
    ...
    _addHost$2: function($name, value) {
      ...
      if (typeof t1 === "string") {
        ...
        if (J.$eq(pos, -1)) {
          ...
          if (J.$gt$n(pos, 0))
            this._host = J.substring$2$s(value, 0, pos);
          else
            this._host = null;
          if (J.$add$ns(pos, 1) === J.get$length$asx(value))
            ...
            try {
              this._port = H.Primitives_parseInt(J.substring$1$s(value, J.$add$ns(pos, 1)), null, null);
            } catch (exception) {
        ...
        throw H.wrapException(Z.HttpException$("Unexpected type for header named " + $name, null));
    },
  ...
  _HttpHeaders_closure: {
    "^": "Closure:13;_captured_this_0",
    call$2: function($name, value) {
      this._captured_this_0._headers.$indexSet(0, $name, value);
      return value;
    }
  },
  _HttpHeaders_toString_closure: {
    "^": "Closure:21;_captured_this_0,_captured_sb_1",
    call$2: function($name, values) {
      var t1, t2, fold, i, t3;
      t1 = this._captured_sb_1;
      t2 = t1._contents += H.S($name);
      t1._contents = t2 + ": ";
      fold = this._captured_this_0._foldHeader$1($name);
      t2 = J.getInterceptor$asx(values);
      i = 0;
      while (true) {
  ...
  _HttpClientRequest: {
    "^": "Object;headers,uri,method,_done,_buffer,encoding,bufferOutput,followRedirects,persistentConnection,contentLength,maxRedirects",
    close$0: function(_) {
      var t1, t2, req;
      t1 = this.headers;
      ...
      t1._headers.forEach$1(0, new Z._HttpClientRequest_close_closure(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
      t1 = $.get$_http();
      t2 = this.uri;
      t2 = P.LinkedHashMap_LinkedHashMap$_literal(["hostname", t2.get$host(t2), "port", t2.get$port(t2), "path", t2._path, "method", "POST"], null, null);
      req = t1.callMethod$2("request", [P._wrapToDart(P.JsObject__convertDataTree(t2)), new Z._HttpClientRequest_close_closure0(this)]);
      for (t1 = this._buffer, t1 = new J.ArrayIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        req.callMethod$2("write", [t1.__interceptors$_current]);
      req.callMethod$1("end");
      return this._done.future;
    },
    add$1: function(_, data) {
      var t1, t2;
      this._buffer.push(K.listToBuf(data));
    ...
    writeAll$2: function(objects, separator) {
      var t1, t2, t3, obj, t4;
      for (t1 = objects.get$iterator(objects), t2 = this.encoding, t3 = this._buffer; t1.moveNext$0(), false;) {
        obj = t1.get$current();
        t4 = t2.get$encoder().convert$1(obj);
        t3.push(K.listToBuf(t4));
        this.contentLength = this.contentLength + t4.length;
        objects.get$length(objects).$sub(0, 1);
        t4 = t2.get$encoder().convert$1(separator);
        t3.push(K.listToBuf(t4));
        this.contentLength = this.contentLength + t4.length;
      }
    }
  ...
  _HttpClientRequest_close_closure: {
    "^": "Closure:13;_captured__headers_0",
    call$2: function($name, values) {
      var t1 = J.$index$asx(values, 0);
      this._captured__headers_0.$indexSet(0, $name, t1);
      return t1;
    }
  },
  _HttpClientRequest_close_closure0: {
    ...
    call$1: [function(res) {
      this._captured_this_1._done.complete$1(0, Z._HttpClientResponse$(res, "POST"));
  ...
  _HttpClientResponse: {
    "^": "Stream;_controller,_res,_reqMethod,redirects,headers",
    get$last: function(_) {
      var t1 = H.setRuntimeTypeInfo(new P._ControllerStream(this._controller), [null]);
    ...
    _HttpClientResponse$2: function(res, _reqMethod) {
      var t1, t2;
      t1 = this._res;
      J.forEach$1$ax(C.JsonCodec_null_null.decode$1(J.$index$asx(J.$index$asx($.get$context(), "global"), "JSON").callMethod$2("stringify", J.$index$asx(t1, "headers"))), new Z._HttpClientResponse_closure(this));
    ...
    static: {_HttpClientResponse$: function(res, _reqMethod) {
        var t1 = new Z._HttpClientResponse(P.StreamController_StreamController(null, null, null, null, false, P.List), res, _reqMethod, H.setRuntimeTypeInfo([], [Z.RedirectInfo]), Z._HttpHeaders$(J.$index$asx(res, "httpVersion"), 80, null));
        t1._HttpClientResponse$2(res, _reqMethod);
        return t1;
      }}
  },
  _HttpClientResponse_closure: {
    "^": "Closure:13;_captured_this_0",
    call$2: [function(key, value) {
      var t1 = this._captured_this_0.headers;
      if (!t1._mutable)
        H.throwExpression(Z.HttpException$("HTTP headers are not mutable", null));
      t1._addAll$2(J.toLowerCase$0$s(key), value);
    }, null, null, 4, 0, null, 29, 15, "call"]
  },
  _HttpClientResponse_onData: {
    "^": "Closure:2;_captured_this_1",
    call$1: [function(buf) {
      var t1, t2;
      t1 = this._captured_this_1._controller;
      t2 = K.bufToList(buf);
      if (t1._state >= 4)
  ...
  _HttpClientResponse_onEnd: {
    "^": "Closure:0;_http$_captured_this_2,_captured_onData_3",
    call$0: [function() {
      var t1 = this._http$_captured_this_2;
      t1._controller.close$0(0);
      t1 = t1._res;
      t1.callMethod$2("removeListener", ["data", this._captured_onData_3]);
...
["", "test/test.dart", , V, {
  "^": "",
  main: [function() {
    var $goto = 0, completer = new P.Completer_Completer(), handler = 1, currentError, t1, t2, t3, t4, req, res;
      ...
      while (true)
        switch ($goto) {
          case 0:
            // Function start
            P.print("#1");
            t1 = P.Uri_parse("http://www.httpbin.org/post", 0, null);
            t2 = Z._HttpHeaders$("1.1", 80, null);
            ...
            t4._asyncComplete$1(new Z._HttpClientRequest(t2, t1, "POST", t3, [], C.Utf8Codec_false, null, null, null, -1, null));
            $goto = 2;
            return H.asyncHelper(t4, main, completer);
          case 2:
            // returning from await.
            req = result;
            P.print("#2");
            t4 = J.getInterceptor$ax(req);
            t4.add$1(req, C.Utf8Codec_false.get$encoder().convert$1("Hello world"));
            P.print("#3");
            $goto = 3;
            return H.asyncHelper(t4.close$0(req), main, completer);
          case 3:
            // returning from await.
            res = result;
            P.print("#4");
            res.listen$1(new V.main_closure());
            P.print("#5");
            // implicit return
...
}, "_dartProxyCtor", "_http", "get$_http", function() {
  return $.get$context().callMethod$2("require", ["http"]);
}, "_http"]);
;
